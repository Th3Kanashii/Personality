...
async def subscribe(message: types.Message, repo: RequestsRepo) -> None:
    """
...
async def subscribed(message: types.Message, repo: RequestsRepo) -> None:
    """
...
async def unsubscribe(message: types.Message, repo: RequestsRepo) -> None:
    """
    ...
    subscriptions = await repo.users.get_user_subscriptions(
...
async def living_library_link(message: types.Message, bot: Bot) -> None:
    """
...
async def main_menu(message: types.Message, repo: RequestsRepo) -> None:
    """
